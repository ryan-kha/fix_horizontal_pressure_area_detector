...
class SideViewDetectorTest(unittest.TestCase):
  ...
  def test_morcos_right(self):
        image_path = "Test_Images/morcos_right.png"
        image_length = 70.1154
        image_height = 34.3508
